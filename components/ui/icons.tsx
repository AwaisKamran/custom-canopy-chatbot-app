...
function IconOpenAI({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    ...
    >
      <path
        d="M10.9103 6.25708L12.8 10.0971L4.13013 25.1541L8.86917e-05 25.1541L10.9103 6.25708Z"
        fill="#585A5F"
      />
      <path
        d="M13.1616 1.77499L9.25005 1.77825L17.9199 16.8353L22.0499 16.8353L13.1616 1.77499Z"
        fill="#585A5F"
      />
      <path
        d="M12.2567 21.0508L14.3522 17.4745L32 17.4745L29.9546 21.0508L12.2567 21.0508Z"
        fill="#585A5F"
      />
      <path
        d="M13.4399 10.7429L15.3599 13.9429L8.95995 25.156L5.12204 25.156L13.4399 10.7429Z"
        fill="#585A5F"
      />
      <path
        d="M18.5598 3.06743L14.7186 3.06572L23.0398 16.8341L27.1934 16.8341L18.5598 3.06743Z"
        fill="#585A5F"
      />
      <path
        d="M10.0903 25.1553L11.9016 21.8925L26.0903 21.8286L24.1703 25.1523L10.0903 25.1553Z"
        fill="#585A5F"
      />
    </svg>
  )
...
function IconColorPicker({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
...
function IconPicture({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
